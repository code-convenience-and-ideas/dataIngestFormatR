...
[![Codecov test coverage](https://codecov.io/gh/code-convenience-and-ideas/dataIngestFormatR/branch/main/graph/badge.svg)](https://app.codecov.io/gh/code-convenience-and-ideas/dataIngestFormatR?branch=main)
[![Lifecycle: experimental](https://img.shields.io/badge/lifecycle-experimental-orange.svg)](https://lifecycle.r-lib.org/articles/stages.html#experimental)
<!-- badges: end -->

The goal of dataIngestFormatR is to simply build up a few simple scripts that parse a shared YAML format I use to specify the datasets I need to load for my analyses.
