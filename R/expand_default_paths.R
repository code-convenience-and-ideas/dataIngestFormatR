...
#' Fills empty path value with the default and expands relative paths
#'
#' @param path_to_check a path entry to expand to an absolute path
#' @param path_default path to use if missing an entry
#'
