...
testthat::test_that("extract_default_names only extracts defaults", {
    entry_sample <- as.list(c("default_val"="a", "c"="d", "default_test"="e", NULL="v"))
...
testthat::test_that("process_default_path_entry fills default path correctly", {
    ...
    # Go through a few different combinations of possibilities and how they should work
    testthat::expect_equal(process_default_path_entry(test_path_1, default_path_1), default_path_1)
    testthat::expect_equal(process_default_path_entry(test_path_2, default_path_1), default_path_1)
    testthat::expect_equal(process_default_path_entry(test_path_3, default_path_1), file.path(cur_dir, test_path_3))
})
