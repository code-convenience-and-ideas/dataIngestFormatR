...
testthat::test_that("prepare_dataset_yaml works", {
  ...
  processed_yaml_out <- prepare_dataset_yaml(
    yaml_data_as_a_list,
    default_path,
...
testthat::test_that("update_list_of_datasets works", {
  ...
  processed_dataset_list <- update_list_of_datasets(
    input_list_data,
    single_data_changer
  )
...
testthat::test_that("extract_file_paths_from_names works", {
  ...
  expected_path_entries <- list(
    file.path(default_path_value, "other"),
    file.path(default_path_value, "logs"),
    file.path(
      file.path(default_path_value, "data"),
      "raw_data"
    )
  )
...
testthat::test_that("prepare_folder_structure_yaml works", {
  input_project_structure <- list(
    "Folders" = list(list("data" = list("name" = "data_dir")))
  )

  default_directory_path <- "."

  processed_folder_structure <- prepare_folder_structure_yaml(
    input_project_structure,
    default_directory_path
  )
